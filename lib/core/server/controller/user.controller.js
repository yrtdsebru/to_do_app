...
exports.login = async (req, res, next) => {
    try {
        ...
        // E-posta ve parolanın model'a uygun girilip girilmediğini kontrol ediyoruz.
        if (!email || !password) {
            throw new Error('Parameter are not correct');
        }

        // Kullanıcının var olup olmadığını kontrol ediyoruz. Service'deki user'ları kontrol ediyoruz. 
